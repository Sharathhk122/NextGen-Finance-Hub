  ...
  const renderImage = (imageData, altText) => {
    ...
    if (typeof imageData === 'string') {
      if (imageData.startsWith('data:image')) {
        ...
        return <img src={`https://bmsp-back.onrender.com${imageData}`} alt={altText} className="w-full h-48 object-contain border border-gray-300 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl" />;
      }
    }
