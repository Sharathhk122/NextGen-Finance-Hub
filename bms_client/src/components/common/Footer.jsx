  ...
  return (
    <footer className="home-footer relative overflow-hidden">
      ...
      <div className="footer-container relative z-10">
        ...
        <div className="footer-bottom border-t border-gray-800 pt-6 mt-8">
          <Text className="text-gray-500">
            &copy; 2025 NextGen Finance Hub. All rights reserved. | Developed by <strong className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">Sharath HK</strong>
          </Text>
        </div>
      </div>
    </footer>
